...
def help_user(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ JOIN Gooys ⭕️", url="https://t.me/Tg_Hydra_Galaxy")]]),
        parse_mode="html",
...
def send_start(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ My Group ⭕️", url="https://t.me/Tg_Hydra_Galaxy")], [InlineKeyboardButton(text="😇 SUPPORT", url="https://t.me/Tg_Hydra_Galaxy"),
